...
import { Sun, Moon, MapPin, CreditCard, Package, CheckCircle, XCircle, Truck, DollarSign } from 'lucide-react';
        ...
        {loading ? (
          ...
          <div className="process-order-container">
            <div className="process-hero">
              ...
              <p className="order-id">SubOrder ID: <span>#{subOrder?._id}</span></p>
            </div>
            ...
            <div className="process-grid">
                ...
                <div className="info-card earnings-card">
                  ...
                  <div className="card-content">
                    <div className="info-row">
                      ...
                      <span className="value">₹{subOrder?.itemsPrice?.toFixed(2)}</span>
                    </div>
                    <div className="info-row">
                      <span className="label">Shipping:</span>
                      <span className="value">₹{subOrder?.shippingPrice?.toFixed(2)}</span>
                    </div>
                    <div className="info-row">
                      <span className="label">GST:</span>
                      <span className="value">₹{subOrder?.taxPrice?.toFixed(2)}</span>
                    </div>
                    <div className="info-row highlight">
                      <span className="label">Subtotal:</span>
                      <span className="value">₹{subOrder?.totalPrice?.toFixed(2)}</span>
                    </div>
                    <div className="info-row commission">
                      <span className="label">Platform Commission:</span>
                      <span className="value">-₹{subOrder?.platformCommission?.toFixed(2)}</span>
                    </div>
                    <div className="info-row earnings">
                      <span className="label">You Earn:</span>
                      <span className="value">₹{subOrder?.sellerEarnings?.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card-content">
                    ...
                    {subOrder?.sellerPaidAt && (
                      <div className="info-row">
                        ...
                        <span className="value">{new Date(subOrder.sellerPaidAt).toLocaleDateString()}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="info-card">
                  ...
                  <div className="card-content">
                    <div className="info-row">
                      ...
                      <span className={`order-status ${subOrder?.orderStatus === "Delivered" ? "delivered" : "processing"}`}>
                    ...
                    <div className="info-row">
                      ...
                      <span className="value">{subOrder?.mainOrder?.orderStatus || "Processing"}</span>
                    </div>
              ...
              {/* Update Section - Show only if THIS suborder is not delivered */}
              {subOrder?.orderStatus !== "Delivered" && (
                  ...
                  <form className="update-form" onSubmit={updateOrderSubmitHandler}>
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        {/* Show options based on THIS subOrder's status */}
                        {subOrder?.orderStatus === "Processing" && (
